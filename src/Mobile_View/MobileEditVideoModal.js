...
import './MobileEditVideoModal.css';

function MobileEditVideoModal(props) {
    ...
    if (props.show === false) {
        ...
        return (
            <div className='MobileVideoRoot'>
                <div className='MobileVideoTextBoxes'>
                ...
                <div className='MobileVideoButtons'>
...
export default MobileEditVideoModal
